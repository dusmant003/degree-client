...
const AddNewMessageModal = ({ isOpen, onClose, onSave }) => {
                ...
                <div className='bg-white p-6 w-full max-w-md shadow-lg rounded-xl'>
                    ...
                    <div className='grid gap-3'>
                        <input
                            ...
                            type="text" placeholder='Name' className='p-2 rounded-md focus:outline-none border' />
                        ...
                        <input
                            ...
                            type="date" placeholder='Enter Date' className='border p-2 rounded-md focus:outline-none' />
                    </div>
                    <div className='flex justify-end items-center gap-2 mt-5 text-white '>
                        ...
                        <button onClick={handleSubmit} className='px-4 py-2 rounded-md bg-blue-600'>Save</button>
                    </div>
                </div>
            </div>
        </>
